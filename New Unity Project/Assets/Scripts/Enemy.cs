...
namespace SpatialPartitionPattern
{
    ...
    public class Enemy : Soldier
    {
        ...
        public Enemy(GameObject soldieerObj, float mapWidth, Grid grid)
        {
            this.soldierTrans = soldieerObj.transform;
            this.soldierMeshRenderer = soldieerObj.GetComponent<MeshRenderer>();
